...
<div class="flex items-baseline mt-0.5 font-medium ">
	...
	<a class="ml-1 text-blue-500 hover:underline font-bold" data-sveltekit-prefetch href="/signup">
		Sign up
	</a>
</div>
...
<form class="mt-10" action="" on:submit|preventDefault={onSubmit}>
	...
	<div class="flex justify-between items-center mb-8">
		...
		<a href="#" class="text-sm text-blue-500 font-bold hover:underline">Forgot password?</a>
	</div>

	<div class="mb-8">
		<button
			type="submit"
			class="btn w-full rounded-3xl loading"
			class:btn-primary={!loading}
			class:loading>Sign in</button
		>
	</div>
